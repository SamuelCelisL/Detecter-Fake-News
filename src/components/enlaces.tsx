...
export default function Enlaces({ setResultado, setError }: EnlacesProps){
  ...
  const analizarEnlace = async () => {
    ...
    return (
        <div className="sm:mx-1 md:mx-6 max-w-[800px] w-full flex flex-col flex-wrap items-center justify-center p-4 rounded-2xl bg-gradient-to-l from-blue-500 to-green-500 shadow-lg hover:shadow-2xl hover:shadow-white hover:text-white hover:border sm:flex-row">
