...
export default function Resultados({ resultado, error }: ResultadosProps) {
    ...
    return (
        <div className="flex flex-col flex-wrap w-auto items-center justify-center p-4 shadow-lg rounded-2xl bg-gradient-to-l from-blue-500 to-green-500 hover:shadow-2xl hover:shadow-white hover:text-white hover:border my-2 sm:m-1 md:m-6 lg:mx-40">
