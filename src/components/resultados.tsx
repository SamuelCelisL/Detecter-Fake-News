...
export default function Resultados({ resultado, error }: ResultadosProps) {
    ...
    return (
        <div className="flex flex-col flex-wrap w-full max-w-[800px] items-center justify-center p-4 shadow-lg rounded-2xl bg-gradient-to-l from-blue-500 to-green-500 hover:shadow-2xl hover:shadow-white hover:text-white hover:border sm:mx-1 md:mx-6">
